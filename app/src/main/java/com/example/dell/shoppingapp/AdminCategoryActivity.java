...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    private ImageView tShirts ,sportsTshirts ,headPhonesHandfree, glasses,femaleDresses,sweater, hatcaps,walletBagsPurses,shoes,Laptops,mobilePhones,Watches;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        walletBagsPurses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminCategoryActivity.this,AdminAddNewProductActivity.class);
                intent.putExtra("category","Wallet And Purses");
                startActivity(intent);
            }
        });
